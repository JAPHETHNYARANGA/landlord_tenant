...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-9a00_dz*u-o88uby(34)l0%)3q3bgn!t%tq%$zogsj=(n3i8pn')
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': settings.SECRET_KEY,  # Replace with your actual secret key
